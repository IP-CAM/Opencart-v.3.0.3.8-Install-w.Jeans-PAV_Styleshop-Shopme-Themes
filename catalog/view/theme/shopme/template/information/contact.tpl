      ...
      <div class="panel panel-default">
        <div class="panel-body">
		  ...
		  <div class="col-sm-6 contact-info">
            ...
            <?php } ?>
            <div class="col-sm-12 address"><strong><?php echo $store; ?>:</strong>
            ...
            <div class="col-sm-12 telephone"><strong><?php echo $text_telephone; ?>:</strong>
              <?php echo $telephone; ?>
              <br />
              <?php if ($fax) { ?>
            ...
            <div class="col-sm-6 map_contact">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="buttons">
          <div class="pull-right">
            <input class="btn btn-white" type="submit" value="<?php echo $button_submit; ?>" />
          </div>
        </div>
      </form>
